export function scoreSOP(text) {
  ...
  categories.push({ name: "Introduction", score: introScore, max: 15 });
  ...
  categories.push({ name: "Academic Background", score: acadScore, max: 20 });
  ...
  categories.push({ name: "Career Goals", score: goalScore, max: 20 });
  ...
  categories.push({ name: "Why This Program", score: whyScore, max: 20 });
  ...
  categories.push({ name: "Writing Quality", score: writeScore, max: 15 });
  ...
  categories.push({ name: "Conclusion", score: concScore, max: 10 });
